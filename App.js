...
form.addEventListener('submit', (event)=>{
    ...
    index = (name.length*surname.length)%20;
     ...
     index = (name.length*date*year)%30;
    ...
    result.innerText = `${first_message} ${second_message} ${third_message} ${fourth_message} our recommendation-${fifth_message} ${sixth_message}`;
